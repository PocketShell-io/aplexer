...
/// Every function in the `src/bin/aplexer/` production modules that calls
...
const PRODUCTION_SOURCE: &str = concat!(
    include_str!("../aplexer/attach.rs"),
    "\n",
    include_str!("../aplexer/attach_input.rs"),
    "\n",
    include_str!("../aplexer/attach_protocol.rs"),
    "\n",
    include_str!("../aplexer/attach_session.rs"),
    "\n",
    include_str!("../aplexer/attach_threads.rs"),
    "\n",
    include_str!("../aplexer/capture_commands.rs"),
    "\n",
    include_str!("../aplexer/cli.rs"),
    "\n",
    include_str!("../aplexer/cli_examples.rs"),
    "\n",
    include_str!("../aplexer/cli_message_args.rs"),
    "\n",
    include_str!("../aplexer/cli_session_args.rs"),
    "\n",
    include_str!("../aplexer/commands.rs"),
    "\n",
    include_str!("../aplexer/diagnostics.rs"),
    "\n",
    include_str!("../aplexer/doctor.rs"),
    "\n",
    include_str!("../aplexer/input_scanner.rs"),
    "\n",
    include_str!("../aplexer/key_overlay.rs"),
    "\n",
    include_str!("../aplexer/launch_commands.rs"),
    "\n",
    include_str!("../aplexer/lifecycle_commands.rs"),
    "\n",
    include_str!("../aplexer/list_helpers.rs"),
    "\n",
    include_str!("../aplexer/list_plain.rs"),
    "\n",
    include_str!("../aplexer/list_tty.rs"),
    "\n",
    include_str!("../aplexer/message_commands.rs"),
    "\n",
    include_str!("../aplexer/mouse.rs"),
    "\n",
    include_str!("../aplexer/rpc.rs"),
    "\n",
    include_str!("../aplexer/rpc_connection.rs"),
    "\n",
    include_str!("../aplexer/scroll.rs"),
    "\n",
    include_str!("../aplexer/scroll_config.rs"),
    "\n",
    include_str!("../aplexer/scroll_input.rs"),
    "\n",
    include_str!("../aplexer/scroll_keys.rs"),
    "\n",
    include_str!("../aplexer/session_commands.rs"),
    "\n",
    include_str!("../aplexer/session_diagnostics.rs"),
    "\n",
    include_str!("../aplexer/session_picker.rs"),
    "\n",
    include_str!("../aplexer/status_bar.rs"),
    "\n",
    include_str!("../aplexer/status_commands.rs"),
    "\n",
    include_str!("../aplexer/switch_targets.rs"),
    "\n",
    include_str!("../aplexer/switching.rs"),
    "\n",
    include_str!("../aplexer/system.rs"),
    "\n",
    include_str!("../aplexer/terminal.rs"),
    "\n",
    include_str!("../aplexer/terminal_status.rs"),
    "\n",
);
...
fn scroll_mode_writes_are_the_only_stream_suspended_ones() {
    ...
    const SUSPENDED_WRITERS: &[(&str, bool)] = &[
        ...
        // Any overlay's frame -- the which-key keymap and the two pickers
        // share the one painting body -- always the first write
        // after the relay was suspended for it.
        ("paint_overlay_lines", true),
